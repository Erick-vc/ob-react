...
// creamos un componente de tipo funcion
...
const Ejemplo2 = () => {
    ...
    // con un elemento del DOOM del componente (vista HTML)
    // ******** EN VES DE USAR EL document.getElementById *************
    const miRef = useRef();
    ...
    /**
     * ? Case 1: Ejecutar SIEMPRE un snippet de código
    ...
    //     console.log("Mostrando Referencia a elemento del DOOM");
    //     console.log(miRef);
    // });
    ...
    //     console.log("Mostrando Referencia a elemento del DOOM");
    //     console.log(miRef);
    // }, [contador1]); // -> o meto al contador2

    /**
     * ? Case 3: Ejecutar SOLO CUANDO CAMBIE CONTADOR1 O CONTADOR2
     * Cada vez que haya un cambio en contador1, se ejecuta lo que diga el useEffect()
